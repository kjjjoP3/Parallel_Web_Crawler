...
/**
 * Guice dependency injection module that installs a {@link PageParserFactory}
 * that can be used to create page parsers.
 */
public final class ParserModule extends AbstractModule {
	...
	/**
	 * Creates a {@link ParserModule} from the given timeout and ignored word
	 * patterns.
	 */
